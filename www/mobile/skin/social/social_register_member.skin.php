...
<div class="mbskin" id="register_member">
    ...
    <div id="sns-link-pnl" class="remodal" data-remodal-id="modal" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
      <p class="strong">혹시 기존 회원이신가요?</p><br>
        ...
        <div class="connect-fg">
            ...
            <div class="connect-desc">
                ...
                이 후 SNS 아이디로 로그인 하시면 기존 아이디로 로그인 할 수 있습니다.<br>
            </div>

            <div id="login_fs">
                아이디<strong class="sound_only"> 필수</strong>
                <span class="lg_id"><input type="text" name="mb_id" id="login_id" class="frm_input " size="20" maxLength="20" ></span>
                비밀번호<strong class="sound_only"> 필수</strong>
                <span class="lg_pw"><input type="password" name="mb_password" id="login_pw" class="frm_input " size="20" maxLength="20"></span>
                <br>
