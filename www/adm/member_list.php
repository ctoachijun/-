...
<div id="member_cont">
  ...
  <div class="partner_list">
    ...
    <div class="p_cnt">
      <div class="p_total">총 : <?=$p_total_cnt?>명</div>
      <div class="p_newbi">이번달 신규 가입자 : <?=newbi(1)?>명</div>
    </div>
    ...
    <div class="m_head">
      ...
      <div class="m_search">
        <form name="fsearch" id="fsearch2" action="./member_list.php" class="local_sch01 local_sch" method="post">
          ...
          <input type="text" name="m_stx" id="m_stx" value="<?=$m_stx?>" placeholder="고객명으로 검색 해 주세요" required class="required frm_input" />
