...
function print_menu2($key, $no='')
{
    ...
    for($i=1; $i<count($menu[$key]); $i++)
    {
        ...
        $str .= '<li data-menu="'.$menu[$key][$i][0].'"><a href="'.$menu[$key][$i][2].'?s_key='.$i.'" class="gnb_2da '.$gnb_grp_style.' '.$gnb_grp_div.$current_class.'">'.$menu[$key][$i][1].'</a></li>';
...
<header id="hd">
    ...
    <div id="hd_top">
     ...
     <div id="logo"><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>"><img src="<?php echo G5_ADMIN_URL ?>/img/top_logo.png" alt="<?php echo get_text($config['cf_title']); ?> 관리자"></a></div>
       ...
       <div id="tnb">
           <ul>
               ...
               <!-- <li class="tnb_li"><button type="button" class="tnb_mb_btn"><?=$member['mb_id']?><span class="./img/btn_gnb.png">메뉴열기</span></button> -->
                 <li class="tnb_li"><font class="tnb_mb_btn"><?=$member['mb_id']?>&nbsp;<span class="tnb_mb_btn_down">▼</span></font>
    ...
    <nav id="gnb" class="gnb_large <?php echo $adm_menu_cookie['gnb']; ?>">
        ...
        <ul class="gnb_ul">
            ...
            <li class="gnb_li<?php echo $current_class;?>">
                ...
                <button type="button" class="btn_op menu-<?php echo $key; ?> menu-order-<?php echo $jj; ?>"><?=$button_title?></button>
...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title"><?php echo $curr_title ?></h1>
